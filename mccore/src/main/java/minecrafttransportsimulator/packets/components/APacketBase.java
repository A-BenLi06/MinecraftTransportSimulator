...
public abstract class APacketBase {
    ...
    public static void initPackets(byte packetIndex) {
        ...
        InterfaceManager.packetInterface.registerPacket(packetIndex++, PacketVehicleParkingChange.class);
        InterfaceManager.packetInterface.registerPacket(packetIndex++, PacketVehicleRotorControl.class);
