...
public class JSONConfigClient {
    ...
    public static class JSONRenderingSettings {
        ...
        public JSONConfigEntry<Boolean> preloadModels = new JSONConfigEntry<>(false, "If true, all pack models are parsed and cached incrementally after joining a world.  This reduces first-render stutter at the cost of retaining every model in memory.");
        public JSONConfigEntry<Integer> modelCacheMaxMiB = new JSONConfigEntry<>(256, "Maximum parsed model vertex data retained in memory, in MiB.  Least-recently-used models are released when this limit is exceeded.  Set to 0 for no limit.");
